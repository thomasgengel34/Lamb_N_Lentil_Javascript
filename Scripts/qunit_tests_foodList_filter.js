...
QUnit.test("foodList_filter-2 verify a filtered list with a filter and IsChecked not checked works", function (assert) {
    ...
    function innerTest1() {
        let response = foodList.filterList(list, filterText, IsChecked);
        return response;
    }
}, 3000);
...
//    function innerTest1() {    
//        let response = foodList.filterList(foodList, filterText, IsChecked);
//        return response;
//    }
//}, 3000);
...
//    foodList = foodList.list.item;
//    let returned = [];
//    const fixture = setupDivForTesting(); 
...
//        function innerTest1() { 
//            let response = foodList.filterList(foodList.list , filterText, IsChecked);
//            return response;
//        }
//    }
//    );
